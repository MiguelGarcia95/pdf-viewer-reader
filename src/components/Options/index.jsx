  ...
  return (
    <section className='options-bar'>
      <section className="container">
        <OnClickBtn className='btn sm' onBtnClick={() => zoomPage(scale + 0.1)} btnText='' btnIcon='fas fa-lg fa-plus' />
        <OnClickBtn className='btn sm' onBtnClick={() => zoomPage(scale - 0.1)} btnText='' btnIcon='fas fa-lg fa-minus' />
